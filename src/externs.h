...
extern void do_cmd_knowledge_pets(void);
extern void do_cmd_knowledge_pets_dismiss(bool forced);
extern void do_cmd_knowledge_pets_rename(void);
...
extern int pet_upkeep_limit(void);
extern int pet_upkeep_cost_x2(monster_type *m_ptr, bool *have_a_unique);
extern void pet_calc_summary(int *pet_count, int *total_levels, int *limit, int *upkeep);
